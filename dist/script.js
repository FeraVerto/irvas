...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(statusMessage); //Собирает все данные из инпутов, помещает их в специальную структуру
      //можно перевести в JSON
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_Modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); //(headerSelector, tabSelector, contentSelector, activeClass)
